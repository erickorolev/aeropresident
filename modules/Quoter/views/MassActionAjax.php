    ...
    public function getItemsDetail(Vtiger_Request $request)
    {
        ...
        if (!empty($setting)) {
            ...
            if (!empty($record)) {
                ...
                if ($request->get("salesorder_id") || $request->get("quote_id") || $request->get("po_id")) {
                    $taxes = $parentRecordModel->getProductTaxes();
                } else {
        ...
        if (!empty($setting)) {
            ...
            if (!empty($record)) {
                ...
                if ($request->get("product_id") || $sourceModule === "Products" || $request->get("productid")) {
                    ...
                    if ($request->get("service_id") || $sourceModule === "Services") {
                        if ($sourceRecord) {
                        ...
                        if ($sourceRecord && in_array($sourceModule, array("Accounts", "Contacts", "Potentials", "Vendors", "PurchaseOrder"))) {
