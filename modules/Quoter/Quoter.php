...
class Quoter extends CRMEntity
{
    ...
    private function addWidgetTo()
    {
        ...
        $adb->pquery("INSERT INTO `vtiger_settings_field` (`fieldid`, `blockid`, `name`, `description`, `linkto`, `sequence`) VALUES (?, ?, ?, ?, ?, ?)", array($max_id, "4", "Item Details Customizer (Advanced)", "Settings area for Quoter", "index.php?module=Quoter&parent=Settings&view=Settings", $max_id));
