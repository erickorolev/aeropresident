        ...
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/Best-Gear-For-Tracking-Big-Woods-Bucks-in-Snow-665x667.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/Here-Comes-The-Sun-in-Mallorca.-Photo-credit-@bageensky-665x667.png">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/aksessuaryi-dlya-vannoy-4-665x667.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">President.aero</h1>
                    <p></p>
                </div>
