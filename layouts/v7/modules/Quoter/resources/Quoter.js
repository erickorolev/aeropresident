            ...
            if (fieldName != currentElementName && name != 'comment') {
                if (currentRow.find('[name="' + fieldName + '"]').length > 0) {
                    if(thisIntance.isGroupTaxMode() && name == 'tax_total'){
                        ...
                        if($.isNumeric(value)){
                            span.html(thisIntance.numberFormat(value));
                        }else{
                            span.html(value);
                        }
        ...
        AppConnector.request(params).then(
            function (response) {
                ...
                if (response.result.isActive == true) {
                    ...
                    if((sourceRecord!= '' && sourceModule != '')|| (sourceRecord == '' && salesorder_id !='' && targetModule =='PurchaseOrder')) {
                    ...
                    //                     if(isAllowBilling == 1){
                    //                         quoterInstance.registerEventForReviewTimeLogButton();
                    //                     }
                    //                     app.helper.hideProgress();
                    //                 }
                    //             }
